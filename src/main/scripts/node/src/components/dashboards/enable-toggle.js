...
const EnableToggle = ({ enabled, onEnableClick, onDisableClick }) => {
    return enabled ? (
            <div className="badge" style={{padding: 2, borderRadius: 4}}>
                <div style={{display: "inline-block", position: "relative", marginRight: 4, marginLeft: 4, top: 1, color: "#6e6", textShadow: "0px 1px 0px rgba(255,255,255,.3), 0px -1px 0px rgba(0,0,0,.7)"}}>
                    On
                </div>
            ...
            <div className="badge" style={{padding: 2, borderRadius: 4}}>
                <div style={{display: "inline-block", position: "relative", marginRight: 4, marginLeft: 4, top: 1, color: "#faa", textShadow: "0px 1px 0px rgba(128,128,128,.4), 0px -1px 0px rgba(0,0,0,.7)"}}>
                    Off
                </div>
